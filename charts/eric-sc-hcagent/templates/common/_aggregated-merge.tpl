...
{{- define "eric-sc-hcagent.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-sc-hcagent.mergeAnnotations" -}}
  {{- include "eric-sc-hcagent.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-sc-hcagent.mergeLabels" -}}
  {{- include "eric-sc-hcagent.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
